...
function runCommand(cmd) {
    try {
        // Inherit stdio so we see output, but we also need to capture it for JSON parsing
        // We'll use formatting to get strings back
...
function main() {
    ...
    // Note: --gas-budget 1000000000 (1 SUI)
